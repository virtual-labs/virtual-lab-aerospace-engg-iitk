...
Menu3=new Array("Introduction","intro.html","",0,35,100); 

Menu4=new Array("Apparatus & Procedure","ap.html","",0,35,100);
	
Menu5=new Array("Results & Discussion ","results.html","",0,35,100);
	
Menu6=new Array("Appendix","appendix.html","",0,35,100);

Menu7=new Array("Gallery","","",6,35,100);
	
Menu7_1=new Array("video1","mov1.htm","",0,30,150);
Menu7_2=new Array("video2","mov2.htm","",0,30,150);
Menu7_3=new Array("video3","mov3.htm","",0,30,150);
Menu7_4=new Array("video4","mov4.htm","",0,30,150);
Menu7_5=new Array("video5","mov5.htm","",0,30,150);
Menu7_6=new Array("video6","mov7.htm","",0,30,150);